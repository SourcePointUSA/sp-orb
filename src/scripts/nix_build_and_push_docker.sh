...
docker tag ${FLAKE_DOCKER_IMAGE_NAME}:latest ${AWS_ECR_ACCOUNT_URL}/${FLAKE_DOCKER_IMAGE_NAME}:0.0.${CIRCLE_SHA1:0:7}
docker push ${AWS_ECR_ACCOUNT_URL}/${FLAKE_DOCKER_IMAGE_NAME}:0.0.${CIRCLE_SHA1:0:7}
